...
function submitForm() {
  ...
  document.querySelector("#bruger-navn").textContent = document.querySelector("#f-name").value;
  document.querySelector("#bruger-navn2").textContent = document.querySelector("#l-name").value;
  document.querySelector("#bruger-nr").textContent = document.querySelector("#nr").value;
  document.querySelector("#bruger-mail").textContent = document.querySelector("#mail").value;
...
const checkboxes = document.querySelectorAll('input[name="checkbox"]');
document.querySelector(".checkbox-text").textContent="";
console.log(checkboxes)
checkboxes.forEach((elem)=>document.querySelector(".checkbox-text").textContent+=elem.value)
